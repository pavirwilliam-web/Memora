...
app.post('/api/ask', requireAuth, async (req, res) => {
  ...
  try {
    ...
    //  - 429 "RESOURCE_EXHAUSTED" : quota par minute dépassé (voir file d'attente ci-dessus) ;
    ...
    if (!apiRes.ok) {
      ...
      // qui masquait la vraie cause (clé invalide, modèle inconnu, quota dépassé, serveur
      // surchargé, etc.).
